...
export default function ChangePasswordControlCenterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (currentPassword !== userControlCenter.password) {
    ...
    try {
      await changeUserPassword(userControlCenter.id, currentPassword, newPassword);

      showNotification("¡Contraseña cambiada exitosamente!", "success");

      setTimeout(() => {
        setIsLoading(false);
        router.push("/control_center/user/profile");
      }, 2000);
    } catch (error) {
