...
import { editProductCategory, getProductCategory } from "@/src/controllers/control_center/cc_stock_product_category/cc_stock_product_category";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await editProductCategory(
        ...
        productCategory.cc_user_business_id
      );
