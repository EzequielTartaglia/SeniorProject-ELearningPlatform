      ...
      <div className="relative">
        ...
        <ul className="flex flex-col gap-5 text-primary list-none p-0 w-full">
          {currentPageItems.map((item) => (
            <li
              key={item.id}
              className="bg-primary rounded-md px-6 py-3 shadow-md transition duration-300 hover:-translate-y-1 border-dark-mode w-full border-primary relative flex items-center justify-between space-x-4"
            >
              <div className="flex items-center space-x-2 overflow-hidden truncate sm:truncate max-w-[400px]">
                <div className="pr-16 sm:pr-16 md:pr-0 lg:pr-0 flex-1">
                  ...
                  {item.progress && item.progress > 0 && (
                    <div className="mt-2">
                      <div className="text-[10px] text-xs md:text-xs text-gray-500">
                        ...
                        <div className="relative w-full bg-gray-200 rounded-full h-2 mt-2">
                          ...
                          <div
                            className={`absolute inset-0 rounded-full ${
                              item.progress < 34
                                ? "bg-red-500"
                                : item.progress >= 34.99 && item.progress <= 50.99
                                ? "bg-orange-500"
                                : item.progress >= 51.99 && item.progress <= 66.99
                                ? "bg-yellow-500"
                                : item.progress >= 67.99 && item.progress <= 99.99
                                ? "bg-green-500"
                                : item.progress >= 100
                                ? "bg-blue-500"
                                : ""
