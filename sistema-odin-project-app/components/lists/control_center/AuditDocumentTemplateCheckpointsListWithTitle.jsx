...
import AuditDocumenTemplateCheckpointList from "./AuditDocumenTemplateCheckpointList";

export default function AuditDocumentTemplateCheckpointsListWithTitle({
  title,
  items,
  sections,
  columnName = "name",
    ...
    <div className="box-theme font-semibold">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {hasData ? (
            <AuditDocumenTemplateCheckpointList
              list={items}
              sections={sections}
