...
drop table if exists public.mercado_pago_business_credentials cascade;
...
create table public.mercado_pago_business_credentials (
  id bigint generated by default as identity not null,
  ...
  constraint mercado_pago_business_credentials_pkey primary key (id),
  constraint mercado_pago_business_credentials_platform_user_business_id_key unique (platform_user_business_id),
  constraint mercado_pago_business_credentials_platform_user_business_id_fkey foreign KEY (platform_user_business_id) references platform_user_business (id) on update CASCADE on delete CASCADE
) TABLESPACE pg_default;