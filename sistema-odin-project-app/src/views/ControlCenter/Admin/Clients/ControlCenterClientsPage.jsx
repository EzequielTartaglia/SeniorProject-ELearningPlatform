...
export default function ControlCenterClientsPage() {
  ...
  return (
    <>
      ...
      <Table
        ...
        buttonAddRoute={`/control_center/admin/clients/new`}
        hasShow={hasShow}
        buttonShowRoute={(id) => `/control_center/admin/clients/${id}`}
        hasEdit={hasEdit}
        buttonEditRoute={(id) => `/control_center/admin/clients/${id}/edit`}
        hasDelete={
          userControlCenter?.cc_user_role_id === 2 ||
          userControlCenter?.cc_user_role_id === 3 ||
          userControlCenter?.cc_user_role_id === 4 ||
