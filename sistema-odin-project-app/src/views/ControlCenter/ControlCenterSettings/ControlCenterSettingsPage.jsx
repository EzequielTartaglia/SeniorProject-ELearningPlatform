...
import { getControlCenterSetting } from "@/src/controllers/control_center/control_center_setting/control_center_setting";
...
export default function ControlCenterSettingsPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const data = await getControlCenterSetting();
        setSettings(data);
        setIsLoading(false);
      } catch (error) {
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <div className="flex justify-center sm:justify-end mt-4 sm:mt-0 space-x-2">
                <Button
                  ...
                  route={"/control_center/control_center_settings/edit"}
                  isAnimated={false}
                  title="Editar"
                  text={"Editar"}
                />
