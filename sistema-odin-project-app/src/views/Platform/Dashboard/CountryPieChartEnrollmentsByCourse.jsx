...
const CountryPieChartEnrollmentsByCourse = ({ enrollments, courses }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-lg w-full">
      <h2 className="text-xl font-bold mb-4 text-center">Recuento de pais por curso</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl">
          {filteredCourses.length > 0 ? (
            filteredCourses.map((course, idx) => {
              ...
              const totalCountries = courseEnrollments.reduce((acc, enrollment) => {
...
export default CountryPieChartEnrollmentsByCourse;
