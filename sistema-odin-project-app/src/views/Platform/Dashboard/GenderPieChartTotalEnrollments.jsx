...
const GenderPieChartTotalEnrollments = ({ enrollments }) => {
  const totalGenders = enrollments.reduce((acc, enrollment) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-lg w-full">
      <h2 className="text-xl font-bold mb-4 text-center">
         Recuento de género en inscripciones
      </h2>
...
export default GenderPieChartTotalEnrollments;
