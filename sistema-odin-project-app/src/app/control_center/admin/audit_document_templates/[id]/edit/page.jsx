import EditAuditDocumentTemplateForm from "@/components/forms/control_center/cc_audit_document_templates/EditAuditDocumentTemplateForm";
...
export default function EditAuditDocumentTemplate({params}) {
  return (
    <ConditionalSessionControlCenterRender
      AuthorizedUserRoles={[1, 2, 3, 4, 7]}
      enablePluginsRequireds={[1]}
      ComponentIfUser={<EditAuditDocumentTemplateForm auditDocumentId={params.id} />}
